...
![npm](https://img.shields.io/npm/v/teeny-express-server?label=version&logo=npm)
![David](https://img.shields.io/david/aversini/teeny-express-server?logo=npm)
![David](https://img.shields.io/david/dev/aversini/teeny-express-server?logo=npm)
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/aversini/teeny-express-server/coverage?label=coverage&logo=github)
